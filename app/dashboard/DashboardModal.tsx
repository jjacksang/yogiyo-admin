...
const DashboardModal: React.FC<DashboardModalProps> = ({ closeModal }) => {
    ...
    // 전화번호 합치기
    const compileCallNumber = () =>
        `<span class="math-inline">\{areaCode\}\-</span>{exchangeNumber}-${subscriberNumber}`;
    ...
    return (
        <div
            className="fixed left-2 overflow-y-auto flex flex-col h-[calc(100vh-196px)] max-h-[600px] min-h-[230px] w-[360px] rounded-lg border border-[rgba(0,0,0,0.8)] bg-white shadow-md text-[rgba(0,0,0,0.6)] cursor-default lg:absolute lg:top-[100px] lg:right-0"
        ...
        >
            <div className="flex flex-col flex-none bg-white rounded-t-lg z-10 pt-4">
                <div
                    className="flex flex-col flex-auto h-auto rounded-b-lg overflow-y-auto bg-white p-0"
                ...
                >
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex gap-2">
                            <input
                                ...
                                type="text"
                                className="mt-1 p-2 border border-gray-300 rounded-md w-1/4"
                                placeholder="지역번호"
                            />
                            <input
                    ...
                    <div className="mb-4">
                        ...
                        <button
                            ...
                            className="py-2 px-4 w-3/1 bg-blue-500 text-white rounded hover:bg-blue-700 transition-colors"
                        >
                            주소 검색
                        </button>
                        <div>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="mt-1 flex justify-between items-center">
                            <input
                                type="text"
                                className="p-1 border border-gray-300 rounded-md text-sm leading-4 font-medium text-gray-700 mr-2 flex-grow w-1/3 h-9"
                                value={iconFileName}
                                readOnly
                            />
                            <input
                            ...
                            <label
                                htmlFor="icon-upload"
                                className="cursor-pointer py-1 px-2 bg-blue-500 text-white rounded hover:bg-blue-700 transition-colors text-sm w-1/4 text-center"
                            >
                                파일 찾기
                            </label>
                        </div>
                    ...
                    <button
                        ...
                        className="py-2 px-4 w-1/2 bg-blue-500 text-white rounded hover:bg-blue-700 transition-colors"
                    >
                        입점 신청 완료
                    </button>
