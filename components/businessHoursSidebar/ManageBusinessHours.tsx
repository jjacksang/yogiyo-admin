                  ...
                  <div className="mb-6">
                    <div className="flex items-center gap-4 mb-4">
                      <div style={{ flex: 1 }}>
                        ...
                        <button className="border border-gray-300 text-gray-700 bg-white rounded-md py-4 px-10" style={{ margin: '8px', marginLeft: '0', height: '60px'}} onClick={handleDailyClick}>
                          매일 같은 시간에 영업해요
                        </button>
                        <button className="border border-gray-300 text-gray-700 bg-white rounded-md py-4 px-10" style={{ margin: '8px', height: '60px'}} onClick={handleDifferentDaysClick}>
                          요일별로 다르게 영업해요 
                        </button>
                        ...
                        {isDailyMode ? (
                          <div>
                            <div className="flex items-center justify-between mb-6">
                              <div>
                                <p style={{ color: '#6B7280', fontSize: '1rem', display: 'inline-block', marginRight: '8px' }}>
                                  매일
                                </p>
                                <p style={{ color: '#6B7280', fontSize: '1rem', display: 'inline-block', marginRight: '16px' }}>
                                  영업일
                                </p>
                              </div>
                              <div className="flex items-center">
                                <p style={{ color: '#6B7280', fontSize: '1rem', marginRight: '8px' }}>
                                  24시간
                                </p>
                                <input type="checkbox" />
                              </div>
