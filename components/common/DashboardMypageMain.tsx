              ...
              <div className="mt-2">
                <div className="flex items-center">
                  ...
                  <div className="flex mt-0 ml-auto">
                    <div onClick={handleDeleteUser} className="text-sm font-normal cursor-pointer" style={{ lineHeight: '19px', color: 'rgba(0, 0, 0, 0.8)' }}>
                      회원탈퇴
                    </div>
                    <div className="border-l border-gray-200" style={{ borderColor: 'rgba(0, 0, 0, 0.1)', height: '16px', margin: '0 12px' }}></div>
                    <div onClick={handleLogout} className="text-sm font-normal cursor-pointer" style={{ lineHeight: '19px', color: 'rgba(0, 0, 0, 0.8)' }}>
                      로그아웃
                    </div>
                  </div>
                </div>
