...
export const Footer = (props: Props) => {
    ...
    return (
        <footer className="px-[22px] py-6 border border-t">
          ...
          {/* 두번째 줄 문구 부분 */}
            <div className="mt-3">
              <div className="flex flex-row items-center h-10 cursor-pointer font-bold text-xs"
                style={{ lineHeight: '16px', padding: '6px 0 8px' }}>
                <div className="inline-flex flex-row items-center mr-4 font-bold text-sm"
                  style={{ lineHeight: '19px', color: 'rgba(0, 0, 0, 0.6)' }}
                >주식회사 위대한상상</div>
                    <button onClick={toggleDetails} 
                      className="relative flex items-center justify-center w-auto max-w-xs bg-transparent h-7 rounded outline-none ml-2"
                    ...
                    {showDetails && (
                      <div className="pt-0 px-4 pb-6">
                          ...
                          <div className="inline-flex flex-row items-baseline max-w-full text-sm leading-[19px] font-normal mb-[10px]"
                           ...
                           >
                            <span 
                              ...
                              style={{ fontSize: '13px', color: 'rgba(0, 0, 0, 0.4)', lineHeight: '18px' }}
                            >
                              대표이사
                            </span>
                              <span 
                                className="ml-2 flex-grow-0 flex-shrink-1 font-normal"
                                style={{ fontSize: '13px', color: 'rgba(0, 0, 0, 0.6)', lineHeight: '18px', wordBreak: 'break-all', overflowWrap: 'break-word' }}
                              >
                                전준희
                              </span>
                            </div>
                            {/* 선 경계부분 */ }
                            <div className="border-l border-[rgba(0,0,0,0.1)]" style={{ borderColor: 'rgba(0, 0, 0, 0.1)', height: '14px', margin: '0px 10px 10px' }}></div>

                            {/* 사업자 등록 번호 부분*/}
                            <div className="inline-flex flex-row flex-none max-w-full text-base font-normal items-baseline mb-2.5"
                              style={{ lineHeight: '19px' }}>
                            <span className="flex-none font-normal" style={{ fontSize:'13px', color: 'rgba(0, 0, 0, 0.4)', lineHeight: '18px' }}>
                              사업자등록번호 
                            </span>
                            <span className="ml-2 flex-shrink flex-grow text-gray-600 text-xs font-normal break-all"style={{ color: 'rgba(0, 0, 0, 0.6)', lineHeight: '18px', fontSize: '13px' }}>
                              211-8868802
                            </span>
                            <a href="#" className="ml-2 bg-transparent no-underline text-current">
                              <button className="relative flex items-center justify-center w-auto max-w-xs bg-transparent h-7 rounded px-2"
                                style={{ boxShadow: 'rgba(0, 0, 0, 0.2) 0px 0px 0px 1px inset', borderRadius: '6px', maxWidth: '480px' }}>
                                <span className="text-xs font-normal mx-0.5" style={{ lineHeight: '16px', color: 'rgba(0, 0, 0, 0.8)' }}>
                                  사업자 정보 확인
                                </span>
                              </button>
                            </a>
                        ...
                        <div className="flex flex-wrap items-center">
                          <div className="inline-flex flex-row flex-none max-w-full text-base font-normal items-baseline mb-2.5"
                            style={{ lineHeight: '19px' }}>
                              <span className="flex-none font-normal ml-2" style={{ color: 'rgba(0, 0, 0, 0.4)', fontSize: '13px', lineHeight: '18px', flex: '0 0 auto' }}>
                                주소
                              </span>
                              <span className="flex-grow-0 flex-shrink ml-2 font-normal break-words" style={{ color: 'rgba(0, 0, 0, 0.6)', fontSize: '13px', lineHeight: '18px' }}>
                          ...
                          <div className="inline-flex flex-row flex-none max-w-full text-base font-normal items-baseline mb-2.5"
                            style={{ lineHeight: '19px' }}>
                            <span className="flex-none font-normal" style={{ color: 'rgba(0, 0, 0, 0.4)', lineHeight: '18px', fontSize: '13px' }}>
                              개인정보보호책임자
                            </span>
                            <span className="ml-2 break-words font-normal text-xs" style={{ color: 'rgba(0, 0, 0, 0.6)', fontSize: '13px', lineHeight: '18px', flex: '0 1 auto' }}>
